...
module.exports.onLoad = () => {
    ...
    if (!fs.existsSync(dirMaterial + "point.png")) request("https://github.com/manhkhac/mirai-1.2.8/raw/data/img/point.png").pipe(fs.createWriteStream(dirMaterial + "point.png"));
}
